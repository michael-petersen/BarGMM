...
for irad,rads in enumerate([[0,1],[1,2],[2,3],[3,4],[4,5]]):
    ...
    A = np.genfromtxt('data/apogee/classifications/3Component_AllFeHCutMembership_Percentiles_reduceSNR_r{}R{}_cyl.csv'.format(minrad,maxrad),skip_header=1,delimiter=',')
...
plt.savefig('figures/allposview_{}.png'.format(component),dpi=300)
...
plt.savefig('figures/allangmomview_{}.png'.format(component),dpi=300)
